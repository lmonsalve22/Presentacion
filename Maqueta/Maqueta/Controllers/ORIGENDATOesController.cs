...
{
    public class ORIGENDATOesController : Controller
    {
        ...
        // GET: ORIGENDATOes/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ORIGENDATOes/Create
